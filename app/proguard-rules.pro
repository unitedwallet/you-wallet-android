...
#
-dontwarn com.wallet.crypto.utcapp.entity.**
-keep class com.wallet.crypto.utcapp.entity.** { *; }

-dontwarn com.wallet.crypto.utcapp.ui.widget.entity.**
-keep class com.wallet.crypto.utcapp.ui.widget.entity.** { *; }

-dontwarn com.wallet.crypto.utcapp.repository.entity.**
-keep class com.wallet.crypto.utcapp.repository.entity.** { *; }

-dontwarn com.wallet.crypto.utcapp.service.**
-keep class com.wallet.crypto.utcapp.service.** { *; }
...
#s扫一扫
-dontwarn com.apex.iot.barcode.**

-keep class com.apex.iot.barcode.** { *;}
   # dagger
